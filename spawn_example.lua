...
mobs:spawn({
	name = "classic_monster:dirt_monster",
...
mobs:spawn({
	name = "classic_monster:dungeon_master",
	nodes = {"default:stone"},
	max_light = 5,
	chance = 9000,
	active_object_count = 1,
...
mobs:spawn({
	name = "classic_monster:lava_flan",
...
mobs:spawn({
	name = "classic_monster:mese_monster",
	nodes = {"default:stone"},
	max_light = 7,
	chance = 5000,
	active_object_count = 1,
...
mobs:spawn({
	name = "classic_monster:sand_monster",
...
mobs:spawn({
	name = "classic_monster:stone_monster",
...
mobs:spawn({
	name = "classic_monster:tree_monster",
