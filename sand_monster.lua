...
mobs:register_mob("classic_monster:sand_monster", {
	type = "monster",
	passive = false,
...
mobs:register_egg("classic_monster:sand_monster", S("Sand Monster"),
		"default_desert_sand.png", 1)


mobs:alias_mob("mobs:sand_monster", "classic_monster:sand_monster") -- compatibility
