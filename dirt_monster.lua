...
mobs:register_mob("classic_monster:dirt_monster", {
	type = "monster",
	passive = false,
...
mobs:register_egg("classic_monster:dirt_monster", S("Dirt Monster"), "default_dirt.png", 1)


mobs:alias_mob("mobs:dirt_monster", "classic_monster:dirt_monster") -- compatibility
