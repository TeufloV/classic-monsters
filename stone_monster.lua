...
mobs:register_mob("classic_monster:stone_monster", {
	type = "monster",
	passive = false,
...
mobs:register_egg("classic_monster:stone_monster", S("Stone Monster"), "default_stone.png", 1)


mobs:alias_mob("mobs:stone_monster", "classic_monster:stone_monster") -- compatibility
